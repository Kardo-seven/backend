...
insert into profile(name, last_name, sur_name, phone, birthday, gender, country,
 ...
 values('name10001', 'lastName', 'surName', 'phone10001', '2024-02-09 09:40:20', 'MAN', 'RUSSIA', 'MOSCOW',  'MOSCOW',
  'RUSSIA', 10001, 10001, 'about', 'true', 'true');

insert into profile(name, last_name, sur_name, phone, birthday, gender, country,
 region, city, citizenship, user_id, avatar_id, about, is_child, is_child_expert)
 values('name10002', 'lastName', 'surName', 'phone10002', '2024-02-09 09:40:20', 'MAN', 'RUSSIA', 'MOSCOW',  'MOSCOW',
  'RUSSIA', 10002, 10002, 'about', 'false','true');

insert into profile(name, last_name, sur_name, phone, birthday, gender, country,
 region, city, citizenship, user_id, avatar_id, about, is_child, is_child_expert)
 values('name10003', 'lastName', 'surName', 'phone10003', '2024-02-09 09:40:20', 'MAN', 'RUSSIA', 'MOSCOW',  'MOSCOW',
  'RUSSIA', 10003, 10003, 'about', 'true', 'false');

insert into profile(name, last_name, sur_name, phone, birthday, gender, country,
 region, city, citizenship, user_id, avatar_id, about, is_child, is_child_expert)
 values('name10004', 'lastName', 'surName', 'phone10004', '2024-02-09 09:40:20', 'MAN', 'RUSSIA', 'MOSCOW',  'MOSCOW',
  'RUSSIA', 10004, 10004, 'about', 'false', 'false');

insert into profile(name, last_name, sur_name, phone, birthday, gender, country,
 region, city, citizenship, user_id, avatar_id, about, is_child, is_child_expert)
 values('name10005', 'lastName', 'surName', 'phone10005', '2024-02-09 09:40:20', 'MAN', 'RUSSIA', 'MOSCOW',  'MOSCOW',
